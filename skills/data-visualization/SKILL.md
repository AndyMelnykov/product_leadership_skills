...
- **Title states the insight**: "Revenue grew 23% YoY" beats "Revenue by Month" — this is the same "lead with the finding" discipline as a research synthesis or a spec's success metric
...
A chart used to support a business case should be held to the same evidentiary bar as a research finding: state the confidence level and don't let the axis choice imply more certainty than the data supports.
