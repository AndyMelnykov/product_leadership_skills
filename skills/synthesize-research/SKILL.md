...
This skill is the practical exercise of two **Customer Insight** competencies from the [PM competency model](../../../docs/pm-competency-model.md):

- **Voice of the Customer** — turning raw, messy input from users into a clear, evidence-backed narrative
- **Fluency with Data** — separating what the data actually shows from what it is assumed to show, and being explicit about confidence

Because this folder exists to support consistent, evidence-based coaching, review, and hiring calibration, treat the output of this skill as usable evidence, not just a report:

- A manager can cite a specific synthesis (with its confidence levels and source attribution) as evidence of "Voice of the Customer" in a performance review.
...
- **Prior synthesis documents**: Earlier findings on the same topic, to check for drift or confirmation over time
...
- **Behaviors**: What users actually did (vs what they say they do)
...
- Which findings would hold up if a skeptical stakeholder challenged the evidence behind them?
- Where did you rely on stated preferences instead of behavior — and does that change your confidence level?
- If a hiring interview asked a candidate to defend one of these findings, which competency would it be testing?
